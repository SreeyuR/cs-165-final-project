...
#SBATCH -J "2TRAIN-TRANSFORMER-OPTUNA"   # job name
...
RUN_BASE="2TRAIN-TRANSFORMER-OPTUNA"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_transformer/optuna-transformer-2train.py
