...
#SBATCH -J "FNO F1 Oversample Optuna"   # job name
...
RUN_BASE="FNO F1 Oversample Optuna"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-f1-oversample.py
