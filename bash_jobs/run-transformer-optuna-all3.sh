...
#SBATCH -J "TRANSFORMER-AUC-ALL-TEST-CMOD"   # job name
...
RUN_BASE="RANSFORMER-AUC-ALL-TEST-CMOD"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_transformer/optuna-transformer-train-all3.py
