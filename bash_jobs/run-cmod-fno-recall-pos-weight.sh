...
#SBATCH -J "RECALL-pos-weight-CMOD-FNO"   # job name
...
RUN_BASE="RECALL-pos-weight-CMOD-FNO"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_fno/optuna-fno-pos-weight-emphasis-recall.py
