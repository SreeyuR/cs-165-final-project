...
#SBATCH -J "FNO Multi AUPRC_F1 Undersample Optuna"   # job name
...
RUN_BASE="optuna-auprc-f1-undersample"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-auprc-f1-undersample.py
