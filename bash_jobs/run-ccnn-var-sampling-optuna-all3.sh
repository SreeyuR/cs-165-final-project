...
#SBATCH -J "VAR-SAMP-CCNN-AUC-ALL3-TEST-CMOD"   # job name
...
RUN_BASE="VAR-SAMP-CCNN-AUC-ALL3-TEST-CMOD"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_ccnn/optuna-ccnn-variable-train-all3.py
