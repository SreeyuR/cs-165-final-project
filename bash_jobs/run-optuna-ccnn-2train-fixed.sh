...
#SBATCH -J "2TRAIN-FIXED-CCNN-OPTUNA"   # job name
...
RUN_BASE="2TRAIN-FIXED-CCNN-OPTUNA"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_ccnn/optuna-ccnn-2train-fixed.py
