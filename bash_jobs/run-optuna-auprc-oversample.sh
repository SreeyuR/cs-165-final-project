...
#SBATCH -J "FNO AUPRC Oversample Optuna"   # job name
...
RUN_BASE="FNO AUPRC Oversample Optuna"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-auprc-undersample.py
