...
#SBATCH -J "Recall_FNO_Undersample_Optuna"   # job name
...
RUN_BASE="optuna-f1-undersample"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-recall-undersample.py
