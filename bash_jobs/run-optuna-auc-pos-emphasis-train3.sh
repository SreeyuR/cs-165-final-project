...
#SBATCH -J "AUC-TRAIN3-POS-EMPHASIS-OPTUNA"   # job name
...
RUN_BASE="AUC-TRAIN3-POS-EMPHASIS-OPTUNA"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-auc-pos-emphasis-train3.py
