...
#SBATCH -J "run-3train-fno-recall-delta-t"   # job name
...
RUN_BASE="run-3train-fno-recall-delta-t"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_fno/optuna-recall-delta-t-fno-var-3train.py
