...
#SBATCH -J "FIXED-FNO-AUC-ALL-TEST-CMOD"   # job name
...
RUN_BASE="FIXED-FNO-AUC-ALL-TEST-CMOD"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_fno/optuna-auc-train3.py
