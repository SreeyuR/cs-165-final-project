...
#SBATCH -J "2TRAIN-var-FNO-OPTUNA"   # job name
...
RUN_BASE="2TRAIN-var-FNO-OPTUNA"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_fno/optuna-fno-2train-var.py
