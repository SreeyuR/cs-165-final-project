...
#SBATCH -J "FNO_Ratio-Undersample"   # job name
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_undersample_ratio.py
