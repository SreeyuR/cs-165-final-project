...
#SBATCH -J "2TRAIN-fixed-FNO-OPTUNA"   # job name
...
RUN_BASE="2TRAIN-fixed-FNO-OPTUNA"
...
# modifies the PYTHONPATH env fixed to include path /groups/tensorlab/sratala/neuraloperator to find neuraloperator
# export PYTHONPATH="/groups/tensorlab/sratala/neuraloperator:$PYTHONPATH"
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_fno/optuna-fno-2train-fixed.py
