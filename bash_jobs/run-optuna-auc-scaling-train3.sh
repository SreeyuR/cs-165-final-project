...
#SBATCH -J "Train3-Scaling-AUC"   # job name
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-auc-scaling-train3.py
