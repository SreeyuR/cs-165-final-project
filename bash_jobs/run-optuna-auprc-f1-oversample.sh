...
#SBATCH -J "FNO AUPRC F1 Oversample Optuna"   # job name
#SBATCH --mail-user=sratala@caltech.edu  # email address
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --mail-type=FAIL
#SBATCH --partition=gpu
#SBATCH --output=runs/${SLURM_JOB_NAME}_RUN.out
#SBATCH --error=runs/${SLURM_JOB_NAME}_ERROR.err

RUN_BASE="FNO AUPRC F1 Oversample Optuna"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-auprc-f1-oversample.py
