...
#SBATCH -J "FNO AUC Normal Sample Optuna"   # job name
...
RUN_BASE="FNO AUC Normal Sample Optuna"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-auc.py
