...
#SBATCH -J "VAR-SAMP-FNO-AUC-ALL3-TEST-CMOD-CASE80"   # job name
...
RUN_BASE="VAR-SAMP-FNO-AUC-ALL3-TEST-CMOD-CASE80"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_fno/optuna-auc-var-train3-v2.py