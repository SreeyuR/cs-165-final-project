...
#SBATCH -J "Scaling-AUC-CMOD"   # job name
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-auc-scaling-cmod.py
