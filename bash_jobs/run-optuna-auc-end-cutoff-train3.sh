...
#SBATCH -J "AUC-CMOD-ALL"   # job name
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-auc-end-cutoff-train3.py
