...
#SBATCH -J "FNO_F1_Undersample_Optuna"   # job name
...
RUN_BASE="FNO_F1_Undersample_Optuna"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-f1-undersample.py
