...
#SBATCH -J "Undersampling-AUC-CMOD"   # job name
...
RUN_BASE="Undersampling-AUC-CMOD"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-auc-undersampling-cmod.py
