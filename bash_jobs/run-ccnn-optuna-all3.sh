...
#SBATCH -J "CCNN-AUC-ALL-TEST-CMOD"   # job name
...
RUN_BASE="CCNN-AUC-ALL-TEST-CMOD"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_ccnn/optuna-ccnn-train-all3.py
