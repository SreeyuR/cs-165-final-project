...
#SBATCH -J "VARIABLE-FNO-AUC-ALL-TEST-CMOD"   # job name
...
RUN_BASE="VARIABLE-FNO-AUC-ALL-TEST-CMOD"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_fno/optuna-auc-var-train3.py
