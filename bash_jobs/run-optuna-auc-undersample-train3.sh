...
#SBATCH -J "UNDERSAMPLE-AUC-TRAIN3-OPTUNA"   # job name
...
RUN_BASE="UNDERSAMPLE-AUC-TRAIN3-OPTUNA"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-auc-undersampling-train3.py
