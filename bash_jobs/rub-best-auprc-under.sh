...
#SBATCH -J "Best AUPRC Undersample"   # job name
...
RUN_BASE="Best AUPRC Undersample"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/auprc-under-optuna-best.py
