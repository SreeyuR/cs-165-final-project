...
#SBATCH -J "ccnn-cmod-train"   # job name
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_ccnn/testing/ccnn-cmod-test.py