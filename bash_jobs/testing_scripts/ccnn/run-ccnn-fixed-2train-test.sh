...
#SBATCH -J "ccnn-fixed-2train-test"   # job name
...
RUN_BASE="ccnn-fixed-2train-test"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_ccnn/testing/ccnn-2train-fixed-test.py