...
#SBATCH -J "ccnn-fixed-3train-test"   # job name
...
RUN_BASE="ccnn-fixed-3train-test"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_ccnn/testing/ccnn-3train-fixed-test.py