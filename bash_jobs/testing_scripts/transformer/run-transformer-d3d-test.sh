...
#SBATCH -J "transformer-d3d-test"   # job name
...
/central/groups/tensorlab/sratala/fusion/bin/python  /groups/tensorlab/sratala/fno-disruption-pred/optuna_transformer/testing/transformer-d3d-test.py