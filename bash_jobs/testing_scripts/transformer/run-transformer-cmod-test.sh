...
#SBATCH -J "transformer-cmod-test"   # job name
...
RUN_BASE="transformer-cmod-test"
...
/central/groups/tensorlab/sratala/fusion/bin/python  /groups/tensorlab/sratala/fno-disruption-pred/optuna_transformer/testing/transformer-cmod-test.py