...
#SBATCH -J "transformer-2train-test"   # job name
...
RUN_BASE="transformer-2train-test"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_transformer/testing/transformer-2train-test.py