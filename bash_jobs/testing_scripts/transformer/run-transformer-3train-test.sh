...
#SBATCH -J "transformer-3train-test"   # job name
...
RUN_BASE="transformer-3train-test"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_transformer/testing/transformer-3train-test.py