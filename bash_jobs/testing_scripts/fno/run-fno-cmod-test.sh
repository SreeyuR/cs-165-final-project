...
#SBATCH -J "cmod-fno-train-test"   # job name
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_fno/testing/fno-cmod-test.py