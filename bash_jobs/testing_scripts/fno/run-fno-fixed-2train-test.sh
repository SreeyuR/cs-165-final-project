...
#SBATCH -J "fno-fixed-2train-test"   # job name
...
RUN_BASE="fno-fixed-2train-test"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_fno/testing/fno-2train-fixed-test.py