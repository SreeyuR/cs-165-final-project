...
#SBATCH -J "fno-fixed-3train-test"   # job name
...
RUN_BASE="fno-fixed-3train-test"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_fno/testing/fno-3train-fixed-test.py