...
#SBATCH -J "3train-fno-var-test"   # job name
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna_fno/testing/fno-3train-var-test.py