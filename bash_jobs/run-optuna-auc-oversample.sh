...
#SBATCH -J "FNO AUC Oversample Optuna"   # job name
...
RUN_BASE="FNO AUC Oversample Optuna"
...
/central/groups/tensorlab/sratala/fusion/bin/python /groups/tensorlab/sratala/fno-disruption-pred/optuna-auc-oversample.py
