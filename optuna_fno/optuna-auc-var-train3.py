...
config_file_path = "/groups/tensorlab/sratala/fno-disruption-pred/config/fno/config-variable-sampling-all3-fno.yaml"
study_name = 'A-NEW_3Train-FNO-AUC-Maximization'
addl_metric = False
wandb_proj_name = "CORRECT-Variable-FNO-Disruption-Tuning"
wandb_group_name = 'variable-fno-tuning'
metrics = ['auc_score']
