...
config_file_path = "/groups/tensorlab/sratala/fno-disruption-pred/config/fno/config_cmod_fno.yaml"
study_name = 'A-cmod-fno-auc'
addl_metric = True
wandb_proj_name = "CORRECT-CMOD-FNO-Disruption-Tuning"
...
def sample_hyperparameters(trial):
    ...
    return {
        ...
        'balance_classes': {
            ...
            'pos_weight_emphasis_factor': trial.suggest_float('pos_weight_emphasis_factor', 2.0, 3.2), # 1.6
