...
config_file_path = "/groups/tensorlab/sratala/fno-disruption-pred/config/ccnn/config_cmod_ccnn_pls.yaml"
study_name = 'A-V2-CCNN_CMOD_AUC' #'TEST-CCNN_3_REACTORS_AUC_MAX'  # 
wandb_proj_name = 'PLS-CORRECT-CCNN_Disruption_Tuning' # 'Test-CCNN_Disruption_Tuning' # 
