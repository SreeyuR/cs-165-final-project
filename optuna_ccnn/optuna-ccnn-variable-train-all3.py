...
#config_file_path = "/groups/tensorlab/sratala/fno-disruption-pred/config/ccnn/config-variable-sampling-all3-ccnn-test.yaml"
config_file_path = "/groups/tensorlab/sratala/fno-disruption-pred/config/ccnn/config-ccnn-optiuna-all3.yaml"
study_name = 'A-NEW_VAR-SAMPLING_CCNN_3_REACTORS_AUC_MAX'  # 'CCNN_3_REACTORS_AUC_MAX' #
wandb_proj_name = 'CORRECT-VAR-SAMPLING-CCNN_Disruption_Tuning' #  'CCNN_Disruption_Tuning' # 
wandb_group_name = 'var-ccnn-tuning'  # 'ccnn-tuning' # 
