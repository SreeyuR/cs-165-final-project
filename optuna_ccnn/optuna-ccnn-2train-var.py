...
config_file_path = "/groups/tensorlab/sratala/fno-disruption-pred/config/ccnn/config_ccnn_2train_var.yaml"
study_name = "A-2_TRAIN_CCNN_AUC_VAR' #'TEST-CCNN_3_REACTORS_AUC_MAX"
