...
config_file_path = "/groups/tensorlab/sratala/fno-disruption-pred/config/ccnn/config_east_ccnn.yaml"
study_name = 'A-CCNN_east_AUC' #'TEST-CCNN_3_REACTORS_AUC_MAX'  # 
wandb_proj_name = 'CORRECT-CCNN_Disruption_Tuning' # 'Test-CCNN_Disruption_Tuning' # 
wandb_group_name = 'ccnn-tuning-east' # 'test-ccnn-tuning'  
