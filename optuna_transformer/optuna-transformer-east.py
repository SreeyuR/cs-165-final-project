...
config_file_path = "/groups/tensorlab/sratala/fno-disruption-pred/config/transformer/config_east_transformer.yaml" 
study_name = 'A-TRANSFORMER_east_AUC_MAX' #'TEST-TRANSFORMER_3_REACTORS_AUC_MAX'
wandb_proj_name = 'CORRECT-east-Transformer_Disruption_Tuning' #'Test-Transformer_Disruption_Tuning'
wandb_group_name = 'east-transformer-tuning' # 'test-transformer-tuning'
